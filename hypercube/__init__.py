...
pusher_radio_1=Radiobutton(pusher_group, text="On", value=True, variable=pusher_radio_val)
pusher_radio_1.pack(expand=1, side=RIGHT)
pusher_radio_2=Radiobutton(pusher_group, text="Off", value=False, variable=pusher_radio_val)
